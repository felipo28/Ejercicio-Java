...
import com.mycompany.proyectobiblioteca.modelo.claseEstante;
import java.util.ArrayList;
import javax.swing.table.DefaultTableModel;

public class vistaInternaEstanteLibros extends javax.swing.JFrame {
    ...
    public void listarTabla(){
        modelo = (DefaultTableModel) tblEstantes.getmodel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaInternaEstanteLibros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaInternaEstanteLibros().setVisible(true);
            }
        });
    }
